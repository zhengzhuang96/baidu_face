...
- (void) request:(NSString *) imageStr images:(NSDictionary *)images faceInfo:(UIImage *)image{
    NSError *error;
    NSString *urlString = @"http://10.145.80.201:8316/api/v3/person/verify_sec?appid=23081777";
