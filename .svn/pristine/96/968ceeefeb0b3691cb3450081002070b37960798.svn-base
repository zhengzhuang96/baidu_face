 ...
 */
package com.rain.baidu_face.platform.ui;
...
import com.rain.baidu_face.R;
import com.rain.baidu_face.platform.ui.utils.CameraUtils;
import com.rain.baidu_face.platform.ui.utils.VolumeUtils;
...
//    }
    ...
    protected static Bitmap base64ToBitmap(String base64Data) {
        byte[] bytes = Base64Utils.decode(base64Data, Base64Utils.NO_WRAP);
        return BitmapFactory.decodeByteArray(bytes, 0, bytes.length);
    }

    @Override
    public void onDetectCompletion(FaceStatusNewEnum faceStatusNewEnum, String s, HashMap<String, ImageInfo> hashMap, HashMap<String, ImageInfo> hashMap1) {
